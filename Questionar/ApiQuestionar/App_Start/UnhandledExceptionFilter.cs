    ...
    public class UnhandledExceptionFilter : ExceptionFilterAttribute
    {
        ...
        public override void OnException(HttpActionExecutedContext actionExecutedContext)
        {
            ...
            if (this.Handlers.TryGetValue(type, out registration))
            {
                ...
                var response = handler(actionExecutedContext.Exception, actionExecutedContext.Request);
        ...
        /// </returns>
        public UnhandledExceptionFilter Register<TException>(HttpStatusCode statusCode) where TException : Exception
        {
        ...
        public UnhandledExceptionFilter Register<TException>(Func<Exception, HttpRequestMessage, HttpResponseMessage> handler)
        ...
        /// </returns>
        public UnhandledExceptionFilter Unregister<TException>() where TException : Exception
        {
